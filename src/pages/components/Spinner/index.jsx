...
export function Spinner({ size = 24 }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 2400 2400" width={size} height={size}>
      <g strokeWidth="200" strokeLinecap="round" stroke="#cccc" fill="none" id="spinner">
